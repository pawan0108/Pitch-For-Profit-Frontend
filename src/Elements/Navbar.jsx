...
function Navbar() {
  ...
  return (
    ...
    >
      <div className="container-fluid px-3 px-lg-4 d-flex justify-content-center align-items-center ">
        {/* Flex row: Logo + Toggler */}
        ...
        {/* Nav Links */}
        <div
          className="collapse navbar-collapse partial-collapse"
          id="navbarNav"
